...
g=simdata.g;
sigma2_a=simdata.sigma_a^2; %Standard deviation of the acceleromter noise [m/s^2].
sigma2_g=simdata.sigma_g^2;%Standard deviation of the gyroscope noise [rad/s]
W=simdata.Window_size;%Window size of the zero-velocity detector [samples] 
...
for k=1:N-W+1
    ...
    ya_m=mean(u(1:3,k:k+W-1),2); %mean value in window
    
    for l=k:k+W-1 %all data in window
